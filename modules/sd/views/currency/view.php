...
?>
    ...
    <div class="row">
<?php
if($providerArPayment->totalCount){
    $gridColumnArPayment = [
    ...
    echo Gridview::widget([
        ...
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Ar Payment'.' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerArTransaction->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Ar Transaction'.' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerIwmItemDetail->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Iwm Item Detail'.' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerPurPoHeader->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Pur Po Header'.' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerPurQuotationHeader->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Pur Quotation Header'.' '. $this->title),
        ],
...
?>
    ...
    <div class="row">
<?php
if($providerPurRfqHeader->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Pur Rfq Header'.' '. $this->title),
        ],
...
if($providerSdPrice->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Sd Price'.' '. $this->title),
        ],
...
if($providerSdSale->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Sd Sale'.' '. $this->title),
        ],
...
if($providerSdShip->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
        'type' => GridView::TYPE_PRIMARY,
        'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode('Sd Ship'.' '. $this->title),
        ],
