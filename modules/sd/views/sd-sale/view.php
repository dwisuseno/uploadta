        ...
        <div class="col-lg-6">
            <?php 
                $gridColumn = [
                    ...
                    [
                        'attribute' => function($model){
                            return $model['billto_sale']['name_customer'].' - '.$model['billto_sale']['code_customer'];
                        },
                        'label' => 'Sd Customer',
                    ],
                ];
                ...
                <div class="col-lg-6">
                    <?php 
                        $gridColumn = [
                            [
                                'attribute' => function($model){
                                    return $model['sdShipcondition']['desc_shipcondition'].' - '.$model['sdShipcondition']['code_shicondition'];
                                },
                ...
                [
                    ...
                    'buttons' => [
                        'view' => function ($url, $model, $key) {
                            $key = $model['id'];
                            $url = Url::to(['sd-salesitem/view', 'id' => $key]);
                        ...
                        'update' => function ($url, $model, $key) {
                            $key = $model['id'];
                            $url = Url::to(['sd-salesitem/update', 'id' => $key]);
