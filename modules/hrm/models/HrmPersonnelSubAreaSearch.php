...
/**
 * app\modules\hrm\models\HrmPersonnelSubAreaSearch represents the model behind the search form about `app\modules\hrm\models\HrmPersonnelSubArea`.
 */
 class HrmPersonnelSubAreaSearch extends HrmPersonnelSubArea
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = HrmPersonnelSubArea::find();
