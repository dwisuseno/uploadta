...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'sd_ship_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\SdShip::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'sd_salestype_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\SdSalestype::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'sd_shipcondition_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\SdShipcondition::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'sd_taxdetail_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\SdTaxdetail::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'sd_customer_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\SdCustomer::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'sd_salesarea_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\master\models\SdSalesarea::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
