...
use app\modules\hrm\models\KraSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * KraController implements the CRUD actions for Kra model.
 */
class KraController extends Controller
{
    ...
    /**
     * Lists all Kra models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new KraSearch();
    ...
    /**
     * Finds the Kra model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Kra the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Kra::findOne($id)) !== null) {
            return $model;
        } else {
