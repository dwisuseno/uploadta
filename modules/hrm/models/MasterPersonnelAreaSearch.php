...
/**
 * app\modules\hrm\models\MasterPersonnelAreaSearch represents the model behind the search form about `app\modules\hrm\models\MasterPersonnelArea`.
 */
 class MasterPersonnelAreaSearch extends MasterPersonnelArea
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = MasterPersonnelArea::find();
