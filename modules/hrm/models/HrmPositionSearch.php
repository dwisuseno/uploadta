...
/**
 * app\modules\hrm\models\HrmPositionSearch represents the model behind the search form about `app\modules\hrm\models\HrmPosition`.
 */
 class HrmPositionSearch extends HrmPosition
{
    /**
     * @inheritdoc
     */
