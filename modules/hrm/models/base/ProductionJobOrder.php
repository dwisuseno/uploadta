...
/**
 * This is the base model class for table "production_job_order".
 *
 * @property integer $id
 ...
 */
class ProductionJobOrder extends \yii\db\ActiveRecord
{
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\hrm\models\ProductionJobOrderQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\hrm\models\ProductionJobOrderQuery(get_called_class());
    }
}
