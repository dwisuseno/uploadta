...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'hr_data_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\hrm\models\HrData::find()->orderBy('employee_id')->asArray()->all(), 'id', 'employee_id'),
        ...
        'employee_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\hrm\models\Employee::find()->orderBy('employee_id')->asArray()->all(), 'id', 'employee_id'),
