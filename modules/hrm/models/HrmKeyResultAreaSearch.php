...
/**
 * app\modules\hrm\models\HrmKeyResultAreaSearch represents the model behind the search form about `app\modules\hrm\models\HrmKeyResultArea`.
 */
 class HrmKeyResultAreaSearch extends HrmKeyResultArea
{
    /**
     * @inheritdoc
     */
