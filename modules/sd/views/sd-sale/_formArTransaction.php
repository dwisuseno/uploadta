...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'ar_transaction_type_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\sd\models\ArTransactionType::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'ar_transaction_status_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\sd\models\ArTransactionStatus::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'ar_document_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\sd\models\ArDocument::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
