...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php?r=hrm">ERP2015</a>
        </div>
        <!-- /.navbar-header -->
        <!-- /.navbar-top-links -->
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul id="collapseTwo" class="panel-collapse collapse nav nav-second-level" role="tabpanel">
                            ...
                            <li><a href="index.php?r=hrm/positions">Positions</a></li>
                            <li><a href="index.php?r=hrm/skill">Skill</a></li>
                            <li><a href="index.php?r=hrm/sub-skill">Subskill</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul id="collapseThree" class="panel-collapse collapse nav nav-second-level" role="tabpanel">
                            <li><a href="index.php?r=hrm/key-result-area">Key Result Area</a></li>
                    ...
                    <li>
                        ...
                        <ul id="collapseOne" class="panel-collapse collapse nav nav-second-level" role="tabpanel">
                            <li class="border-bot"><a href="index.php?r=hrm/unique-work">Unique Work</a></li>
                            <li><a href="index.php?r=hrm/analysis-of-work">Analysis Of Work</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
