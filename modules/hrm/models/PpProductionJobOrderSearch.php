...
/**
 * app\modules\hrm\models\PpProductionJobOrderSearch represents the model behind the search form about `app\modules\hrm\models\PpProductionJobOrder`.
 */
 class PpProductionJobOrderSearch extends PpProductionJobOrder
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PpProductionJobOrder::find();
