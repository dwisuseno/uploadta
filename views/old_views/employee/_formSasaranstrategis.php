...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'kra_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\Kra::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowSasaranstrategis(' . $key . '); return false;', 'id' => 'sasaranstrategis-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . 'Sasaranstrategis',
