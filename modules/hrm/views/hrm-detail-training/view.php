...
<div class="hrm-detail-training-view">
    ...
    <div class="row">
        ...
        <div class="col-sm-3" style="margin-top: 15px">
            ...
            <?= Html::a('Update', ['update', 'id' => $model->id, 'hrm_training_id' => $model->hrm_training_id, 'hrm_employee_id' => $model->hrm_employee_id], ['class' => 'btn btn-primary']) ?>
            <?= Html::a('Delete', ['delete', 'id' => $model->id, 'hrm_training_id' => $model->hrm_training_id, 'hrm_employee_id' => $model->hrm_employee_id], [
                'class' => 'btn btn-danger',
                'data' => [
