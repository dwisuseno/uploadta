...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'personnel_sub_area_id' => [
            'label' => 'Hrm personnel sub area',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\hrm\models\HrmPersonnelSubArea::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
                'options' => ['placeholder' => 'Choose Hrm personnel sub area'],
            ],
