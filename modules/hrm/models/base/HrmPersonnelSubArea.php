...
/**
 * This is the base model class for table "hrm_personnel_sub_area".
 *
 * @property integer $id
 ...
 * @property \app\modules\hrm\models\HrmPersonnelArea $personnelArea
 */
class HrmPersonnelSubArea extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasOne(\app\modules\hrm\models\HrmPersonnelArea::className(), ['id' => 'personnel_area_id']);
    }
...
/**
    ...
    /**
     * @inheritdoc
     * @return \app\modules\hrm\models\HrmPersonnelSubAreaQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\hrm\models\HrmPersonnelSubAreaQuery(get_called_class());
    }
}
