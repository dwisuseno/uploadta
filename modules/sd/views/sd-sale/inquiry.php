...
<div class="sd-sale-index">
    ...
    <p>
        <?= Html::a('Create Inquiry', ['createinquiry'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
            ...
            'template' => '{convertinquiry} {completeinquiry}',
            'header' => 'Action',
            'buttons' => [
                'convertinquiry' => function ($url, $model, $key) {
                    if($model['inquirystatus_sale'] == '0'){
                        return Html::a(
        ...
        [
            'class' => 'yii\grid\ActionColumn',
            'template' => '{viewinquiry} {updateinquiry} {deleteinquiry}',
            'buttons' => [
                'viewinquiry' => function ($url, $model, $key) {
                ...
                'updateinquiry' => function ($url, $model, $key) {
                ...
                'deleteinquiry' => function ($url, $model, $key) {
