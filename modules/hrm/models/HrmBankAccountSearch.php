...
/**
 * app\modules\hrm\models\HrmBankAccountSearch represents the model behind the search form about `app\modules\hrm\models\HrmBankAccount`.
 */
 class HrmBankAccountSearch extends HrmBankAccount
{
    /**
     * @inheritdoc
     */
