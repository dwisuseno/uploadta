...
echo TabularForm::widget([
    ...
    'attributes' => [
        'employee_id' => ['type' => TabularForm::INPUT_HIDDEN, 'columnOptions' => ['hidden' => true]],
        'skill_id' => [
            'label' => 'Skill',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\modules\hrm\models\Skill::find()->orderBy('id')->asArray()->all(), 'id', 'id'),
